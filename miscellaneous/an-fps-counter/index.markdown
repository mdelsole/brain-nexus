...
This code is available in all tutorials starting from [Tutorial 9 : VBO indexing](mdelsole.github.io/brain-nexus/intermediate-tutorials/tutorial-9-vbo-indexing/); see [tutorial09_vbo_indexing/tutorial09.cpp](https://github.com/opengl-tutorials/ogl/blob/master/tutorial09_vbo_indexing/tutorial09.cpp#L142) . Other performance tools are available in [Tools - Debuggers](mdelsole.github.io/brain-nexus/miscellaneous/useful-tools-links/#debugging-tools).
